<h1 align="center">AlphaMind</h1>

<p align="center">
  面向 A 股市场的多 Agent 智能投研系统<br>
  基于 <a href="https://github.com/TauricResearch/TradingAgents">TauricResearch/TradingAgents</a> 架构深度特化<br>
...
<p align="center">
  <a href="https://github.com/hcygit1/AlphaMind/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/hcygit1/AlphaMind?style=social"/></a>
  <a href="https://github.com/hcygit1/AlphaMind/network/members"><img alt="Forks" src="https://img.shields.io/github/forks/hcygit1/AlphaMind?style=social"/></a>
...
**AlphaMind 的目标**：把 TradingAgents 的多 Agent 辩论架构真正落地到 A 股，不是简单翻译，而是从数据层、Agent 角色、交易规则三个维度做深度特化。
...
```bash
# Python >= 3.10
git clone https://github.com/hcygit1/AlphaMind.git
cd AlphaMind
pip install -e .
...
> 想要什么功能？欢迎开 [Issue](https://github.com/hcygit1/AlphaMind/issues) 提需求。
