...
_ALPHAMIND_HOME = os.path.join(os.path.expanduser("~"), ".alphamind")

DEFAULT_CONFIG = {
    "project_dir": os.path.abspath(os.path.join(os.path.dirname(__file__), ".")),
    "results_dir": os.getenv("ALPHAMIND_RESULTS_DIR", os.path.join(_ALPHAMIND_HOME, "logs")),
    "data_cache_dir": os.getenv("ALPHAMIND_CACHE_DIR", os.path.join(_ALPHAMIND_HOME, "cache")),
    "memory_log_path": os.getenv("ALPHAMIND_MEMORY_LOG_PATH", os.path.join(_ALPHAMIND_HOME, "memory", "trading_memory.md")),
