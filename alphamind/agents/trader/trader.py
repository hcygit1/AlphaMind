...
from alphamind.agents.schemas import TraderProposal, render_trader_proposal
from alphamind.agents.utils.agent_utils import build_instrument_context, get_language_instruction
from alphamind.agents.utils.structured import (
    bind_structured,
