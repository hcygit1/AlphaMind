...
def render_sidebar() -> None:
    ...
    st.markdown(
        ...
        <div style="text-align:center; margin-bottom:1.5rem;">
            <span style="font-size:2rem; font-weight:800; color:#ff5a1f;">Alpha</span><span style="font-size:2rem; font-weight:800; color:#f5f1eb;">Mind</span>
            <div style="font-size:0.85rem; color:#888; margin-top:0.2rem;">
                A股多Agent投研系统
            </div>
            <div style="font-size:0.7rem; color:#555; margin-top:0.3rem;">
                by <a href="https://github.com/hcygit1" style="color:#ff5a1f; text-decoration:none;">hcygit1</a>
            </div>
        </div>
        """,
